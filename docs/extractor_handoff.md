...
- or a downloaded ghost folder such as `data/raw/ghosts/<map>/top_1000_1010`
...
dotnet run --project .\src\extractor-csharp\RacingLine.csproj -- --replay-dir ".\data\raw\ghosts\Spring 2026 - 02\top_1000_1010" --output-root ".\data\raw\trajectories" --map "Spring 2026 - 02"
```
